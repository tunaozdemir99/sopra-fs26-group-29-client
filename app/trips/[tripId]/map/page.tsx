...
const MapPage: React.FC = () => {
  ...
  const handleScheduleFromMap = async (
    values: { name: string; date: Dayjs; startTime: string; endTime: string },
  ) => {
    if (!selectedLocation) return;
    setScheduling(true);
    try {
  ...
  const markers: MapMarker[] = [
    ...
    ...(selectedLocation
      ? [{
        ...
        label: selectedLocation.label.split(",")[0].trim(),
      }]
      : []),
  ];
    ...
    <div style={{ padding: "16px 0" }}>
          ...
          <Button
            ...
            onClick={() => {
              ...
              scheduleForm.setFieldsValue({
                name: selectedLocation.label.split(",")[0].trim(),
              });
      ...
      >
        <Form
          form={scheduleForm}
          layout="vertical"
          onFinish={handleScheduleFromMap}
          style={{ marginTop: 16 }}
        >
          <Form.Item
            name="name"
